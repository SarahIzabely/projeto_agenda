# Generated by Django 5.2.6 on 2025-10-09 23:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('usuarios', '0002_usuarioadaptado_is_professional'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profissional', models.ForeignKey(limit_choices_to={'is_professional': True}, on_delete=django.db.models.deletion.CASCADE, related_name='horarios', to=settings.AUTH_USER_MODEL)),
            ],
            options={
